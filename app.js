...
(() => {
  ...
  const I18N = {
    en: {
      ...
      'svc3.flag':  'flagship',
      'svc3.body':  'Acting as your <strong>fractional Head of Digital + Product</strong>. Same scope I run for I Dom You: Paid Media, the measurement layer, UX/UI of site &amp; app, the <span class="kw">SEO + AIO</span> copy, and the roadmap that connects them.',
      ...
      'svc3.usedBy': 'Used for I Dom You ↗',
      'svc.usedFor': 'Used for I Dom You ↗',
    ...
    fr: {
      ...
      'svc3.flag':  'flagship',
      'svc3.body':  'En tant que <strong>Head of Digital + Produit fractionné</strong>. Même périmètre que sur I Dom You : Paid Media, couche de mesure, UX/UI site &amp; app, copy <span class="kw">SEO + AIO</span>, et la roadmap qui relie tout ça.',
      'svc3.l1': 'Paid Media · Google · Meta · LinkedIn',
      ...
      'svc3.usedBy': 'Utilisé pour I Dom You ↗',
      'svc.usedFor': 'Utilisé pour I Dom You ↗',
