...
(() => {
  ...
  const I18N = {
    en: {
      ...
      'c2.role': '<strong>End-to-end studio build.</strong> A French personal-finance podcast had reach in audio but no digital home. The studio designed it, wrote it, coded it, audited it, and started landing studios.',
      ...
      'c4.d1':   'Founder',
      'c4.d2':   'Built live',
      'c4.role': 'Own product. Studio-built and operator-led · shipped v1, June 2026.',
      ...
      'c4.whyP': '9 years optimizing other operators\' funnels shaped what a great page has to do. Aiah is where the studio applies it to its own product.',
      'c4.m1Num': '4 Jun 2026',
    ...
    fr: {
      ...
      'c2.role': '<strong>Build studio, de bout en bout.</strong> Un podcast français sur les finances perso avait de l\'écoute mais pas de présence digitale. Le studio l\'a dessiné, écrit, codé, audité, et a démarré les studios.',
      ...
      // case 4 · Aiah
      'c4.tag': 'produit maison',
      'c4.status':'v1 live',
      'c4.d1':   'Fondateur',
      'c4.d2':   'Construit en live',
      'c4.role': 'Produit maison. Construit et opéré par le studio · v1 livrée, juin 2026.',
      ...
      'c4.whyP': '9 ans à optimiser les funnels d\'autres opérateurs ont façonné ce qu\'une bonne page doit faire. Aiah, c\'est là que le studio l\'applique à son propre produit.',
